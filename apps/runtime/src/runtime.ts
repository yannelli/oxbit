  ...
  const server = http.createServer((request, response) => {
    void (async () => {
      ...
      response.writeHead(200, {
        ...
        "Content-Security-Policy": `default-src 'self'; script-src 'self' 'sha256-baG6zrI9qQ7n/0Uu0tcqeYXQC5vQ8ZWJY9nJ2PK7KPs=' blob: ${target.endsWith(".html") ? importMapHashes(content.toString("utf8")).join(" ") : ""}; style-src 'self' 'unsafe-inline' data: https: http:; img-src 'self' data: blob: https: http:; media-src 'self' data: blob: https: http:; font-src 'self' data: https: http:; connect-src 'self' ws: wss:; worker-src 'self' blob:; frame-src 'self' blob:; object-src 'none'; base-uri 'self'; frame-ancestors 'self'`,
