...
export default defineConfig({
  ...
  webServer: { command: "pnpm exec tsx scripts/language/browser-runtime.ts", cwd: "../..", url: "http://127.0.0.1:9535/api/health", timeout: 30000, reuseExistingServer: false, env: { OXBIT_LANGUAGE_BROWSER_PORT: "9535", OXBIT_LSP_CACHE: process.env.OXBIT_LSP_CACHE ?? path.join(os.tmpdir(), "oxbit-managed-language-smoke-cache") } },
});
